# Theory Sprint: CI, Docker, Compose, env and reproducible setup
...
- Hiểu rõ lý thuyết cốt lõi về CI, Docker, Compose, env and reproducible setup.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về CI, Docker, Compose, env and reproducible setup.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến CI, Docker, Compose, env and reproducible setup.
- **My answer**:
  - ...
