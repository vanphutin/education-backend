# Theory Sprint: Test pyramid, unit/e2e, mocking boundaries, Supertest
...
- Hiểu rõ lý thuyết cốt lõi về Test pyramid, unit/e2e, mocking boundaries, Supertest.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về Test pyramid, unit/e2e, mocking boundaries, Supertest.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến Test pyramid, unit/e2e, mocking boundaries, Supertest.
- **My answer**:
  - ...
