# Theory Sprint: Relations, ERD, snapshot vs live seat layout
...
- Hiểu rõ lý thuyết cốt lõi về Relations, ERD, snapshot vs live seat layout.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về Relations, ERD, snapshot vs live seat layout.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến Relations, ERD, snapshot vs live seat layout.
- **My answer**:
  - ...
