# Theory Sprint: Transaction, isolation, row lock, race condition
...
- Hiểu rõ lý thuyết cốt lõi về Transaction, isolation, row lock, race condition.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về Transaction, isolation, row lock, race condition.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến Transaction, isolation, row lock, race condition.
- **My answer**:
  - ...
