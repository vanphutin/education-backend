# Theory Sprint: Embeddings, vector similarity, pgvector, mock provider
...
- Hiểu rõ lý thuyết cốt lõi về Embeddings, vector similarity, pgvector, mock provider.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về Embeddings, vector similarity, pgvector, mock provider.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến Embeddings, vector similarity, pgvector, mock provider.
- **My answer**:
  - ...
