# Theory Sprint: Redis, BullMQ, retry, timeout, job idempotency
...
- Hiểu rõ lý thuyết cốt lõi về Redis, BullMQ, retry, timeout, job idempotency.
...
## 4. Mini Lab
- **Goal**: Kiểm chứng thực tế về Redis, BullMQ, retry, timeout, job idempotency.
- **Code/log**:
```typescript
...
## 6. Interview Drill
- **Question**: Trình bày hiểu biết và tradeoff liên quan đến Redis, BullMQ, retry, timeout, job idempotency.
- **My answer**:
  - ...
