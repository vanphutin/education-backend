# Khung tự học Backend NestJS thực chiến - Movie Ticket Booking - 8 tuần

Tài liệu này là lộ trình tự học Backend tại nhà trong 8 tuần thông qua một project lớn xuyên suốt: **Movie Ticket Booking Backend API**.
...
Không học theo kiểu xem khóa học cho xong. Mỗi tuần đều phải tạo artifact thật: code, PR, test, migration, API docs, evidence chạy thử hoặc demo.
...
*   [Tuần 1 - Backend foundation và Movie API skeleton](lo-trinh/tuan-1.md)
*   [Tuần 2 - Node.js runtime và NestJS request pipeline](lo-trinh/tuan-2.md)
*   [Tuần 3 - PostgreSQL, TypeORM và schema rạp/phim/suất chiếu](lo-trinh/tuan-3.md)
*   [Tuần 4 - Auth, RBAC và seat holding transaction](lo-trinh/tuan-4.md)
*   [Tuần 5 - Booking, ticket, testing, CI và Docker](lo-trinh/tuan-5.md)
*   [Tuần 6 - payOS, background jobs, AI semantic search và embeddings](lo-trinh/tuan-6.md)
*   [Tuần 7 - Capstone sprint 1: hoàn thiện AI + payment + admin workflow](lo-trinh/tuan-7.md)
*   [Tuần 8 - Capstone sprint 2: hardening, docs, demo và phỏng vấn](lo-trinh/tuan-8.md)
